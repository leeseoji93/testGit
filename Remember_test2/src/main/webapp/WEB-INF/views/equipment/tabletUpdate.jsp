...
<c:set value="${detailTablet}" var="dto_c"/>
<h3>상세 정보 수정</h3>
<form name="tabletUpdateSave" id="tabletUpdateSave" action="tabletUpdateSave" method="post" onkeydown="if(event.keyCode==13){event.returnValue=false;}"
	...
	<tr align="right">
		<td colspan="2"> 
			<select class="select200_27" id="staff_id" name="staff_id">
				<option value="" label="관리자 선택">관리자 선택</option>
