...
<jsp:include page="../include/menu_admin.jsp">
  ...
  <jsp:param name="pageTitle" value="가정통신문수정"  />
   </jsp:include>
	<div class="page">
		<div class="page-wrapper">
			...
			<div class="msgboxDiv"><div class="msgBox" id="msgBox"></div></div>
				<form id="Home_communicationUpdate" action="Home_communicationUpdate" name="Home_communicationUpdate" method="post" onkeydown="if(event.keyCode==13){event.returnValue=false;}" enctype="multipart/form-data">
				<div class="Home_communicationForm_Content">	
					...
					<c:set value="${Home_communicationList}" var="Home_communicationInfo"/>
						<label for="Home_communicationUpdate_title">제목</label><input type="text" class="long_input2 Home_communicationForm_title" id="Home_communicationUpdate_title" name="title" value="${Home_communicationInfo[0].title}">					
						<label for="Home_communicationUpdate_Kinds">종류</label>
						<select id="Home_communicationUpdate_Kinds" class="middle_select Home_communicationForm_Kinds" name="tag_id">
						...
						<select id="Home_communicationUpdate_class" class="middle_select Home_communicationForm_class" name="class_id">
...
<!-- 									<img src="images/image_ujacar_290x290.png"> -->
					...
					<div class="Home_communicationUpdate_MiddleContent">
						...
						<div id="Home_communicationForm_textarea" class="Home_communicationForm_textarea">		   				  
							<textarea id="Home_communicationForm_textarea_content" name="content" placeholder = "여기에 입력해주세요">${Home_communicationInfo[0].content}</textarea>				
						</div>
					</div>
					
					<div class="Home_communicationForm_BottomContent"><!-- 파일 첨부, 버튼  -->
						<label for="fileName">파일 첨부</label>
						<input type="text" id="fileName" class="Homefile_input_textbox" readonly >
					...
					<input type="hidden"  name="communication_id" id="communication_id" value="${communication_id}"/>
...
$(function() {			
	...
	$("#Home_communicationUpdate").validate({
	    ...
	    messages: {
	    	title: {
	            required: "제목을 입력해주세요.",
	            regex : "제목은 최소2자 이상 15자 이하 만 가능 합니다."				    		
	        },
	    	tag_id : {
	    		required: "종류를 선택해주세요."
	    	},
...
$(document).ready(function(){
	var tag_id = "${Home_communicationList[0].tag_id}";
	$("#Home_communicationUpdate_Kinds").val(tag_id).attr("selected", "selected");
	
	var class_id = "${Home_communicationList[0].class_id}";
	$("#Home_communicationUpdate_class").val(class_id).attr("selected", "selected");
