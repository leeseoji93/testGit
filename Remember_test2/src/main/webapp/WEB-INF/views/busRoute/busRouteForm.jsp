...
.cusInsertTable2 label{
	...
	<jsp:include page="../include/menu_admin.jsp">
		...
		<jsp:param name="pageTitle" value="노선 등록"  /> 
	</jsp:include>
	<div class="page">
		<div class="page-wrapper">
			<div class="pageTitle"><h2>노선 등록</h2></div>
			<form action="busRouteInput" id="busRouteForm_form" method="post" class="stepForm" onkeydown="if(event.keyCode==13){event.returnValue=false;}">
			<!-- progressbar -->
					...
					<div class="cusInsertTable2">
						<table style="font-size: 13px;">
							<tr>
								<th>노선이름</th>
								<td colspan="4">
									<input type="text" name="route_name" id="route_name" class="BR_input1 big_input1"/>	
								</td>
<!-- 								<td>	 -->
<!-- 									<label id="route_name-error" class="validFail validLabelM" for="route_name"></label>						 -->
<!-- 								</td>								 -->
							</tr>
							<tr id="Step1_routeStart">
								<th>출발시간</th>
								<td colspan="4">
									<input type="text" name="route_start" id="route_start" class="BR_input2 big_input1" placeholder="출발시간을 입력 해주세요."/>
								</td>

<!-- 								<td>	 -->
<!-- 									<label id="route_start-error" class="validFail validLabelM" for="route_start"></label>																			 -->
<!-- 								</td>							 -->
							</tr>
							<tr id="Step1_routeType">
								<th>등/하원</th>
								<td>
									<input type="radio" name="route_type" value="등원" checked="checked">등원
								</td>
								<td>
									<input type="radio" name="route_type" value="하원">하원
								</td>
<!-- 								<td>	 -->
<!-- 									<label id="route_type-error" class="validFail validLabelM" for="route_type"></label>																							  						 							 -->
<!-- 								</td>							 -->
							</tr>						
							<tr id="Step1_routeSem">
								<th>운행학기</th>
								<td>
...
<!-- 								<td>		 -->
<!-- 									<label id="route_sem-error" class="validFail validLabelM" for="route_sem"></label>																							  						 							 -->
<!-- 								</td>							 -->
							</tr>						
						</table>		
						</div>			
						<input type="hidden" name="route_use" value="true">					
					...
					<div class="routeForm">
						<div class="stepContent" >
							<label>코스이름</label><input type="text" class="big_input" name="course_name" id="course_name">
						</div>
							...
							<div id="layerWindow" class="layerWindow">
								...
								<div id="loginLayer" class="loginLayer loginTypeA">
									...
									<div class="layerPopContent">
										...
										<input id="timepicker1" class="timepicker1" type="text" name="timepicker1" placeholder="도착시간을 입력 해주세요." /> 
			...
			<!-- 							<a onclick="closeLayer2(timepickerStation.value)" style="cursor: hand">닫기</a>&nbsp; -->	
						...
						<div>
							<div id="layerWindow1" class="layerWindow">
								...
								<div id="loginLayer1" class="loginLayer loginTypeA">
									...
									<div class="layerPopContent">
										<div class="arriveTitle">도착시간</div>
										<input id="timepicker2" class="timepicker2" type="text" name="timepicker1" placeholder="도착시간을 입력 해주세요." /> 
										<script>
					...
					<fieldset id="fieldset_5">
						...
						<div class="TeacherCollocate">
							...
							<div class="TeacherCollocate" style="margin:0 auto;">
...
// 	console.log($('#kidsCollocate_content'+station_id).children('div').eq(2).children('div'));
