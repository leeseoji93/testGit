...
//            console.log("format_output시작");
             if (settings.show_meridian) {
               ...
               return tim + ":" + mini + " " + meri;
                 ...
                 mini = Math.min(Math.max(parseInt(mini), 00), 59);
                 if (mini < 10)
                     mini = "0" + mini;
         ...
         min_hour_value: 1,
         max_hour_value: 24,
         show_meridian: false,         //true 하면  am,pm 생김 
         step_size_hours: '1',
         step_size_minutes: '1',
      ...
      return this.each(function() {
         ...
         var new_ele = $(
            "<div class='timepicker_wrap " + settings.custom_classes + "'>" +
               ...
               "<div class='mins'>" +
                  ...
                  bottom_arrow_button +
               "</div><div><input type='button' id='stationtimepic' class='btn_done'></div>");
         if(settings.show_meridian){
            new_ele.append(
               "<div class='meridian'>" +
                  top_arrow_button +
         ...
         $('.btn_done').on("click", function(event) {
        	 ...
        	 console.log("check:"+($(this).parent().parent().parent().children('input').eq(0).attr('id')));
        	 set_value();
        	 if(($(this).parent().parent().parent().children('input').eq(0).attr('id'))=='route_start'){
        		 close_timepicki();
        	/* var checkValue = $("#route_start").val();      		     		 
              if(checkValue!=""){            
               }
               else{
               } */
        	 }
        	 else if(($(this).parent().parent().parent().children('input').eq(0).attr('id'))=='timepicker2'){
	    		 close_timepicki();
	             closeLayer3();
        		 /*var checkValue = $("#timepicker2").val();
	             if(checkValue!=""){
	    		 ...
	    		 close_timepicki();
	             closeLayer2(timepickerStation.value);
	             /*var checkValue = $("#timepicker1").val();
	             if(checkValue!=""){
         ...
         $(".timepicki-input").keydown(function (keyevent) {
        	 ...
        	 if (keyevent.keyCode == 13) {
                 ...
                 if(($(this).parent().parent().parent().parent().children('input').eq(0).attr('id'))=='route_start'){
                     var checkValue = $("#route_start").val();
...
//                     } 
                  ...
                  else if(($(this).parent().parent().parent().parent().children('input').eq(0).attr('id'))=='timepicker2'){
                     var checkValue = $("#timepicker2").val();
